...
public class DefaultServerProvider implements ServerProvider {
  ...
  String getServerPropertiesPath() {
    ...
    if (StringUtils.hasLength(serverPropertiesPath)) {
  ...
  private String getCustomizedServerPropertiesPath() {
    ...
    if (StringUtils.hasLength(serverPropertiesPathFromSystemProperty)) {
    ...
    if (StringUtils.hasLength(serverPropertiesPathFromEnvironment)) {
